...
const playCameraPosLeft = new THREE.Vector3(-5, 80, -110); // Diagonal Esquerda padrão
const playCameraPosRight = new THREE.Vector3(5, 80, -110);  // Diagonal Direita espelhada [2]
