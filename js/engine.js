...
const menuCameraPos = new THREE.Vector3(-50, 50, -50); // Câmera perto e dramática no menu
const playCameraPosLeft = new THREE.Vector3(-50, 50, -110); // Diagonal Esquerda padrão
const playCameraPosRight = new THREE.Vector3(50, 50, -110);  // Diagonal Direita espelhada [2]
